...
class SplashViewModelFactory(val api : GovApi, val model : MountModel, val clubModel : ClubModel,val tourApi : TourApi) : ViewModelProvider.Factory{
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        return SplashViewModel(api, model, clubModel,tourApi) as T
    }
